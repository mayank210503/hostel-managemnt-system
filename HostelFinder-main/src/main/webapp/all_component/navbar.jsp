	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<c:if test="${userobj.role eq 'admin' }">
				<li class="nav-item"><a class="nav-link" href="addhostel.jsp">
						<i class="fas fa-map-pin"></i> Add Hostels
				</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<c:if test="${userobj.role eq 'admin' }">
				<a href="#" class="btn btn-light mr-2"><i
					class="fas fa-door-open"></i> Admin</a>
				<a href="logout" class="btn btn-light"><i class="fas fa-user"></i>
					Logout</a>
			</c:if>

			<c:if test="${userobj.role eq 'user' }">
				<a href="#" class="btn btn-light mr-1" data-toggle="modal"
					data-target="#exampleModal"> <i class="fas fa-door-open"></i>
					${userobj.name }
				</a>
			...
			<c:if test="${empty userobj }">
				<a href="login.jsp" class="btn btn-light mr-2"><i
					class="fas fa-door-open"></i> Login</a>
